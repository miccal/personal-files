...
brew install aspell gh gnuplot jupyterlab mas pdftoipe pipgrip pwgen rsync unar archaeology apparency etrecheckpro folx google-chrome ipe launchcontrol m-libreoffice m-mpv m-tex-live-utility m-tor-browser mathpix-snipping-tool microsoft-teams obs omnidisksweeper sage slack-beta suspicious-package texshop textbuddy vmware-horizon-client xquartz zoom
```
